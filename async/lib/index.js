...
const githubRepository = "Microsoft/TypeScript";
/**
...
function main() {
    return __awaiter(this, void 0, Promise, function* () {
        ...
        try {
            ...
            let github = new github_1.GitHubClient({ token: githubToken });
...
function printRecentPullRequests(github, owner, repo) {
    return __awaiter(this, void 0, Promise, function* () {
        ...
        let pullRequests = yield github.listPullRequests(owner, repo, { per_page: 5 });
        ...
        for (let pullRequest of pullRequests) {
            ...
            let commits = yield github.listPullRequestCommits(owner, repo, pullRequest.number, { per_page: 5 });
            ...
            for (let commit of commits) {
                ...
                let message = utils_1.formatMessage(commit.commit.message, 60, 100);
            ...
            let comments = yield github.listPullRequestComments(owner, repo, pullRequest.number, { per_page: 5 });
            if (comments.length) {
                ...
                for (let comment of comments) {
                    ...
                    for (let line of utils_1.formatMessage(comment.body, 100)) {
                        console.log(`        | ${line}`);
                    }
                    console.log();
                }
